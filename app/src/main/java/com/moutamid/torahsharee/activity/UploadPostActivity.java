...
import com.moutamid.torahsharee.databinding.ActivityUploadPostBinding;
...
//                .changeFormatWhen(1, TimeUnit.HOURS, "HH:MM:SS").build();
        ...
        Stopwatch stopwatch = new Stopwatch() {
            ...
            @NonNull
            @Override
            public CharSequence getCurrentFormattedTime() {
                return "HH:MM:SS";
            }
            ...
            @Override
            public void setTime(long l, @NonNull TimeUnit timeUnit) {
                b.timestampTv.setText(String.valueOf(l));
            }
